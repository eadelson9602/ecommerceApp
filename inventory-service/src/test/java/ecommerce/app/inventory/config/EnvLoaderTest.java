package ecommerce.app.inventory.config;
...
class EnvLoaderTest {
	...
	private static final String TEST_PROP = "ENV_LOADER_INVENTORY_TEST_PROPERTY";
	...
	void load_withTempDirContainingEnv_setsPropertyFromEnv() throws Exception {
		Path tempDir = Files.createTempDirectory("envloader-inv-test");
